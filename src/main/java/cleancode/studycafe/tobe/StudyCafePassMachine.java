...
public class StudyCafePassMachine {
    ...
    private Optional<StudyCafeLockerPass> selectLockerPass(StudyCafeSeatPass selectedPass) {
        ...
        Optional<StudyCafeLockerPass> lockerPassCandidate = findPassCandidateBy(selectedPass);
    ...
    private Optional<StudyCafeLockerPass> findPassCandidateBy(StudyCafeSeatPass pass) {
