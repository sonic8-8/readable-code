...
public class MinesweeperGame {
    ...
    private final static String[][] BOARD = new String[BOARD_ROW_SIZE][BOARD_COL_SIZE];
    private final static Integer[][] NEARBY_LAND_MINE_COUNTS = new Integer[BOARD_ROW_SIZE][BOARD_COL_SIZE];
    private final static boolean[][] LAND_MINES = new boolean[BOARD_ROW_SIZE][BOARD_COL_SIZE];
    public static final int LAND_MINE_COUNT = 10;
    public static final String FLAN_SIGN = "⚑";
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (doesUserChooseToPlantFlag(userActionInput)) {
                BOARD[selectedRowIndex][selectedColIndex] = FLAN_SIGN;
                checkIfGameIsOver();
