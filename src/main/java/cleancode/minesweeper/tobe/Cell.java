...
public class Cell {
    ...
    public static Cell of(int nearbyLandMineCount, boolean isClosed, boolean isEmpty, boolean isLandMine) {
        return new Cell(nearbyLandMineCount, isClosed, isEmpty, isLandMine);
    }
